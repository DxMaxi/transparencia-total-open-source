...
> **V5.1 a V5.28 integradas; ativação remota de staging pendente:** o painel privado usa
> login por convite,
...
> mandato e não existe adaptador de publicação de perfis nesta entrega. O plano e a checklist
> de fecho estão em
